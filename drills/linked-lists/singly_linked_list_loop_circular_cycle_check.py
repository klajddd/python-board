...
Since fast_runner can't skip over slow_runner, at most slow_runner will run around the cycle once and 
fast_runner will run around twice. 
...
def contains_cycle(first_node):
    ...
    # check fast_runner.next as it moves by 2
...
# time O(n)
# space O(n)
def contains_cycle_less_efficient(first_node):
